...
export const TimePickerDropdown: React.FC<TimePickerDropdownProps> = ({
  ...
  const timeOptions = [
    '0:00am', '0:15am', '0:30am', '0:45am', // 00:00 - 00:45
    ...
    '0:00pm', '0:15pm', '0:30pm', '0:45pm', // 12:00 - 12:45
  ...
  return (
    <div className={`absolute z-50 mt-1 w-36 max-h-48 overflow-y-auto bg-white border border-gray-200 rounded-md shadow-lg ${className}`}>
      {timeOptions.map((time) => (
        <div 
          key={time} 
          className={`p-2 text-sm hover:bg-gray-100 cursor-pointer ${selectedTime === time ? 'bg-blue-100' : ''}`}
