...
const FlashcardWorkspaceStatistic: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    const data = await flashcardService.getFlashcardStatisticByWorkspace(workspaceId);
  ...
  return (
    <div className="flex h-screen">
      <FlashcardWorkspaceSidebar currentSelected="flashcard-statistic" workspaceId={workspaceId!} />
...
export default FlashcardWorkspaceStatistic;
