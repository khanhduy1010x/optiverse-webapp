    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white px-6 py-2 rounded-lg font-medium shadow-sm"
        />
      </div>
      ...
      {!achievements || achievements.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-gray-300 p-12 text-center bg-white/70">
          <p className="text-gray-600">No achievements yet. Create your first achievement!</p>
        </div>
      ) : (
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-xl">
            <div className="flex flex-col items-center mb-5">
              ...
              <h3 className="text-lg font-semibold text-gray-900 text-center">Xác nhận xóa Achievement</h3>
              <p className="text-sm text-gray-600 text-center mt-1">
                Bạn có chắc chắn muốn xóa achievement này không? Hành động này không thể hoàn tác.
              </p>
            </div>
