...
const ErrorDisplay: React.FC<ErrorDisplayProps> = ({ error, loading }) => {
  ...
  return (
    <>
      {error && (
        <div className="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-lg shadow-md dark:bg-red-900/30 dark:border-red-700 animate-fadeIn">
      ...
      {loading && (
        <div className="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg shadow-md dark:bg-blue-900/30 dark:border-blue-700">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-blue-800 dark:text-blue-200">{t('Loading data, please wait...')}</p>
            </div>
          </div>
        </div>
      )}
