    ...
    return (
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg p-8 text-center border border-blue-100 dark:border-gray-700">
        ...
        <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto text-base">
          {t(
            'You have not added any friends yet. Use the search function to find and connect with other users.'
          )}
        </p>
        <button
    ...
    <div>
      ...
      <div className={GROUP_CLASSNAMES.gridResponsive}>
        {friends.map(friend => {
          ...
          return (
            <div key={friend._id} className={GROUP_CLASSNAMES.cardContainer}>
              <div
                className={
              ...
              <div className="p-5 flex items-start justify-between">
                <div className={GROUP_CLASSNAMES.flexItemsCenter}>
                  <div
                    className={`w-16 h-16 rounded-xl bg-gradient-to-br ${gradientClass} flex items-center justify-center text-white text-2xl font-bold mr-4 shadow-md transform transition-transform group-hover:scale-105`}
                  >
                    {initial}
                  </div>
                  <div>
