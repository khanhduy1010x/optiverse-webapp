                        ...
                        <div className="flex items-center bg-white  rounded-lg shadow-sm border border-gray-200  focus-within:ring-blue-200 transition-all duration-200">
                          ...
                          <div className="flex items-center gap-2 px-3">
                            <button
                              ...
                              disabled={isSaving}
                              className="px-4 py-1.5 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                            >
                              {isSaving && (
